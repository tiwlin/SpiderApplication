    ...
    public abstract class DBHelperSQL
    {
        ...
        public static DataSet search(string str, string table)
        {
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                ...
                {
                    _log.Error("search() -- str=[" + str + "],table=[" + table + "]");
                    throw e;
                }
            }
        }
        ...
        public static int ExecuteSqlTran(List<CommandInfo> list, List<CommandInfo> oracleCmdSqlList)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    string oraConnectionString = PubConstant.GetConfigString("ConnectionStringPPC");
        ...
        public static object GetSingle(string SQLString)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand(SQLString, connection))
                {
                    ...
                    {
                        _log.Error("GetSingle() -- SQLString=[" + SQLString + "]");
                        connection.Close();
                        throw e;
                    }
                }
        ...
        public static int ExecuteSql(string SQLString, params SqlParameter[] cmdParms)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    {
                        _log.Error("returnDs() -- SQLString=[" + SQLString + "],tempTable=[" + cmdParms + "]");
                        throw e;
                    }
                }
            }
        ...
        public static object GetSingle(string SQLString, params SqlParameter[] cmdParms)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    {
                        _log.Error("GetSingle() -- SQLString=[" + SQLString + "],cmdParms=[" + cmdParms + "]");
                        throw e;
                    }
                }
            }
        ...
        public static DataSet Query(string SQLString, params SqlParameter[] cmdParms)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                using (SqlDataAdapter da = new SqlDataAdapter(cmd))
                {
                    ...
                    {
                        _log.Error("Query() -- SQLString=[" + SQLString + "],cmdParms=[" + cmdParms + "]");
                        if (cmdParms != null && cmdParms.Length>0)
                        {
                            _log.Error("Query() -- length=[" + cmdParms.Length + "], cmdParms.value0=[" + cmdParms[0].Value + "]");
                        }
                        throw new Exception(ex.Message);
                    }
                    return ds;
        ...
        public static DataSet returnDs(DataSet ds, string sqlStr, string tempTable)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                {
                    _log.Error("returnDs() -- sqlStr=[" + sqlStr + "],tempTable=[" + tempTable + "]");
                    throw (e);
                    // ds = null; 
                    //return ds;
                }
        ...
        public static SqlDataReader ExecuteReader(string connectionString, CommandType cmdType, string cmdText, bool ClerParams, params SqlParameter[] commandParameters)
        {
            ...
            {
                _log.Error("ExecuteReader() -- connectionString=[" + connectionString + "],cmdText=[" + cmdText + "],commandParameters=[" + commandParameters + "]");
                conn.Close();
                throw;
            }
        }
